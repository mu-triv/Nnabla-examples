...
/// Input buffer sizes.
#define NNABLART_VALIDATION_INPUT0_SIZE (4096)
/// Pointer of allocated buffer.
float* nnablart_validation_input_buffer(void* context, int index);

/// Number of output buffers.
#define NNABLART_VALIDATION_NUM_OF_OUTPUT_BUFFERS (3)
/// Output buffer sizes.
#define NNABLART_VALIDATION_OUTPUT0_SIZE (640)
#define NNABLART_VALIDATION_OUTPUT1_SIZE (65536)
#define NNABLART_VALIDATION_OUTPUT2_SIZE (65536)
/// Pointer of allocated buffer.
float* nnablart_validation_output_buffer(void* context, int index);
/// Number of parameter buffers.
#define NNABLART_VALIDATION_NUM_OF_PARAM_BUFFERS (3)
/// Parameter buffer sizes.
#define NNABLART_VALIDATION_PARAM0_SIZE (576)
#define NNABLART_VALIDATION_PARAM1_SIZE (10240)
#define NNABLART_VALIDATION_PARAM2_SIZE (10)
/// Pointer of allocated buffer.
